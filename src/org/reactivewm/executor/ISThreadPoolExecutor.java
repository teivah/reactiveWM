 ...
 * <ol>
 *
 * <li> In the default {@link ISThreadPoolExecutor.AbortPolicy}, the
 * handler throws a runtime {@link RejectedExecutionException} upon
 * rejection. </li>
 *
 * <li> In {@link ISThreadPoolExecutor.CallerRunsPolicy}, the thread
 * that invokes {@code execute} itself runs the task. This provides a
 * simple feedback control mechanism that will slow down the rate that
 * new tasks are submitted. </li>
 *
 * <li> In {@link ISThreadPoolExecutor.DiscardPolicy}, a task that
 * cannot be executed is simply dropped.  </li>
 *
 * <li>In {@link ISThreadPoolExecutor.DiscardOldestPolicy}, if the
 ...
 * @author Doug Lea
 */
public class ISThreadPoolExecutor extends AbstractExecutorService {
    /**
    ...
    public ISThreadPoolExecutor(int corePoolSize,
                              ...
                              long keepAliveTime,
                              TimeUnit unit,
                              BlockingQueue<Runnable> workQueue, ThreadExecutable executable) {
        this(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue,
             Executors.defaultThreadFactory(), defaultHandler, executable);
    }
    ...
    public ISThreadPoolExecutor(int corePoolSize,
                              ...
                              TimeUnit unit,
                              BlockingQueue<Runnable> workQueue,
                              RejectedExecutionHandler handler, ThreadExecutable executable) {
        this(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue,
             Executors.defaultThreadFactory(), handler, executable);
    }
    ...
    public static class CallerRunsPolicy implements RejectedExecutionHandler {
         ...
         */
        public void rejectedExecution(Runnable r, ISThreadPoolExecutor e) {
            if (!e.isShutdown()) {
                r.run();
            }
        }
    ...
    public Future<?> submit(Runnable task, boolean controller) {
		...
		RunnableFuture<Object> ftask = newTaskFor(task, controller,
				null);
